      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Zaskia Store adalah destinasi fashion untuk remaja yang mencintai gaya lembut
            dan feminin. Kami percaya bahwa setiap remaja berhak mengekspresikan diri
            melalui pakaian yang nyaman, cantik, dan mencerminkan kepribadian mereka.
          </p>
